  ...
  <a href="#" className="flex items-center">
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-800 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
               Sign  up
                <svg className="w-3.5 h-3.5 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                </svg>
            </a>
            <a href="#" className="inline-flex justify-center items-center py-4 px-8 text-base font-bold text-center text-gray-900 rounded-lg 
    ...
    <div className='mt-16'>
        <img src='https://cdn.pixabay.com/photo/2023/09/05/16/39/sunrise-8235461_1280.jpg' width={800} className='mx-auto w-auto md:w-[800px]'/>
    </div>
    </div>
